...
valid_detector_type = ["YOLO4", "YOLO5", "MaskRCNN", "FasterRCNN", "BackgroundSubtractor", "Detectron2", "Aruco"]
...
def validate_detector_parameters(det_params: dict) -> bool:
    ...
    elif det_params["model_type"] == "Aruco":
        valid = valid and _validate_aruco_parameters(det_params)
    else:
...
def _validate_aruco_parameters(det_params: dict) -> bool:
    valid = True
